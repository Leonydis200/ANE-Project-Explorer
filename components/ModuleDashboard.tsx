...
export default function ModuleDashboard() {
  ...
  if (!current && modules.length > 0) {
    return (
      <div className="p-6">
        ...
        />
        <div className="mt-4">
          <Link to="/modules" className="text-blue-600 hover:text-blue-800 underline">
            ← Back to Modules
          </Link>
        </div>
      </div>
  ...
  return (
    <ErrorBoundary
      fallback={
        <div className="p-6 text-red-500">Something went wrong with the module dashboard.</div>
      }
    >
      <motion.div
        initial={{ opacity: 0 }}
      ...
      >
        ...
        >
          <div
            className={`p-4 rounded-lg text-white ${current.color} shadow-lg flex flex-col md:flex-row md:items-center gap-4`}
          >
